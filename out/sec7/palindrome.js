...
console.log('palindrome("amanaplanacanalpanama")', palindrome("amanaplanacanalpanama"));
console.log('palindrome("amanaplanacanalpandemonium")', palindrome("amanaplanacanalpandemonium"));
